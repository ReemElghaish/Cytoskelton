...
os.chdir("D:/cytoskeleton/Alzheimer")


# read_the_data
file_name= "D:/cytoskeleton/Alzheimer/cyto_data.csv"
...
clf= SVC(kernel='rbf', C=100,gamma=0.0001, random_state=42, probability=True)
...
plt.errorbar(
    ...
    rfecv.cv_results_["mean_test_score"],color="#11aa00")
plt.title("Recursive Feature Elimination \nwith correlated features")
plt.figtext(.6, .6, "Optimal number of features=302")
plt.show()
